...
from sistema.views import IndexView, ProductoView, BuscarView, CheckoutView, carrito_view, eliminar_producto, NotFoundedView
...
urlpatterns = [
    ...
    path('resultadosVacios/', NotFoundedView, name='resultadosVacios'),
]
